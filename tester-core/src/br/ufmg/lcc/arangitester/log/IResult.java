...
public interface IResult {
	 ...
	 * @param msg Error msg
	 * @param e Error Stack trace to log
	 */
	 ...
	 * the name.
	 * @param date An object date representing the actual time. Cannot be null.
	 * @param method The method that called the screenshot. If its null, it wont
	 * be used.
	 * @return The name of the screenshot. 
	 * The name will be like this:<br/> 25112008--150630_828--verifyTextInside
	 */
	 ...
	 * @param date An object date representing the actual time. Cannot be null.
	 * @param name A string to compose the name of screenshot
	 ...
	 * @param screenShotName The name of the screenshot file, without the extension.
	 ...
	 * @param screenShotName The name of the screenshot WITHOUT any file extension
	 * @see takeScreenshot
	 */
	 ...
	 * @param path : The name of the screenshot file, WITH the extension. Like screen123.png
	 * @param motivation : The motivation of the screenshot, that will tell how 
	...
	/**
	 * Skip a test case
	 * @param name of test case to be skiped
	 */
	 ...
	 * @param name Simbolic name for the test case
	 */
	 ...
	 * @param name Simbolic name for the use case
	 * @param obs List of observations which will save in UseCase object
	 */
